...
//        check(this, ResourceAllocationRolePredicates.checkPermissionsToManagePunctualRoomsOccupationStateInstants);
    ...
    public void setRequest(PunctualRoomsOccupationRequest request) {
        if (request == null) {
            throw new SpaceDomainException("error.PunctualRoomsOccupationStateInstant.empty.request");
        }
    ...
    public void setRequestState(RequestState state) {
        if (state == null) {
            throw new SpaceDomainException("error.PunctualRoomsOccupationStateInstant.empty.state");
        }
    ...
    public void setInstant(DateTime instant) {
        if (instant == null) {
            throw new SpaceDomainException("error.PunctualRoomsOccupationStateInstant.empty.instant");
        }
